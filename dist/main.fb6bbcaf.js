...
function randomNumGenA() {
  var max = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
  var min = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var amount = arguments.length > 2 ? arguments[2] : undefined;
  var arr = [];
...
updateColours = function updateColours(colourPaletteSet) {
  for (var d = 0; d < 4; d++) {
...
var a = [];
var colourArray = []; //mondrian DOM selector

var mondrian = document.querySelector('.mondrian'); // build columns (x) and rows (y)

var x = randomNumGen(6, 3);
var y = randomNumGen(7, 2); // multiply together to calculate number of items

var total = x * y; // let palette = document.querySelectorAll('.palette');
...
function createAndAppend() {
  ...
  document.querySelector('.mondrian').style.gridTemplateColumns = "".concat(randomNumGenA(10, 0, x));
  document.querySelector('.mondrian').style.gridTemplateRows = "auto, ".concat(randomNumGenA(10, 0, y));
  a.forEach(function (element) {
    element.style.backgroundColor = "".concat(colors[randomNumGen(10) - 1]);
    element.style.gridColumn = "auto / span ".concat(randomNumGen(2));
    element.style.gridRow = "auto / span ".concat(randomNumGen(2));
  });
}
